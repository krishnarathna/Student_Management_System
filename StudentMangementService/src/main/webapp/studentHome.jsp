...
try
{
		...
		ResultSet rs = st.executeQuery("SELECT * FROM student_details INNER JOIN student_result ON student_details.rollno = student_result.rollno WHERE student_details.rollno = " + roll);
		if (rs.next()) {
